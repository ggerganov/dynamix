...
{
    int ia;
    void set_a(int) { ia = 3243; }
    int multi();
};

void a_set_a(int* self, int val)
{
    //self->ia = val;
}

int a_multi(const a* self)
{
    return self->ia;
}
...
void a2_set_a(a2* self, int val)
{
     self->ia2 = val + 1;
}

int a2_multi(const a2* self)
{
    return self->ia2 + 1;
}
